...
SELECT em.first_name || " " || em.last_name employee_name, em.title employee_title, em2.first_name || " " || em2.last_name supervisor_name, em2.title supervisor_title
FROM employee em
LEFT JOIN employee em2
ON em.reports_to = em2.employee_id
ORDER BY 1;
